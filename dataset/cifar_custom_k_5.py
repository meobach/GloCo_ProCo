    ...
    def __getitem__(self, index):
        ...
        if self.transform is not None:
          if(self.data_type=="train"):
            ...
            list_index_pos=random.sample(list_index,5)
            ...
            pos_4=self.transform(Image.fromarray(self.data[list_index_pos[3]]))
            pos_5=self.transform(Image.fromarray(self.data[list_index_pos[4]]))
            im_2 = self.transform(img)
            return [im_1,im_2],[pos_1,pos_2,pos_3,pos_4,pos_5],label
          else:
            im_1=self.transform(img)
            return im_1,label
